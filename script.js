...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangku Aull","Semangat terus nggih Kuliah nyaaa Aku ada pertanyaan nih buat kamu Ayangg", "question").then(function () {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuu iyaaa ${sender} juga kangen ${nama} , makasihhh yaa Ayyy`).then(function () {
                          Swal.fire('Terakhir sayang').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('yahhh , emang ga kangen sama ayangmuu', '', 'error').then(function () {
              ...
              Swal.fire(`Yakin ga suka sama ${sender}?`, '', 'error').then(function () {
                Swal.fire('Yaudah dehh sayang,makasih bikin sedih :((')
              })
            }
          })
        })
